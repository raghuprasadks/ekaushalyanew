...
const UpdateProduct = () => {
    ...
    const addSpecs = () => {
        ...
        setSpecsInput({ title: "", description: "", videourl: "" });
    }
    ...
    const newProductSubmitHandler = (e) => {
        ...
        formData.set("introductoryvideo", introductoryvideo);
    ...
    useEffect(() => {
        ...
        if (product && product._id !== productId) {
            ...
            setIntroductoryVideo(product.introductoryvideo)
        }
        if (error) {
        ...
        <>
            ...
            <form onSubmit={newProductSubmitHandler} encType="multipart/form-data" className="flex flex-col sm:flex-row bg-white rounded-lg shadow p-4" id="mainform">
                ...
                <div className="flex flex-col gap-3 m-2 sm:w-1/2">
                    ...
                    <h2 className="font-medium">Introductory Video</h2>
                    <div className='flex flex-col gap-3 m-2 sm:w-1/2'>
                        <TextField
                        label= "Inroductory Video"
                        type='text'
                        variant='outlined'
                        size='samll'
                        value={introductoryvideo}
                        onChange={(e)=> setIntroductoryVideo(e.target.value)}
                        />
                    </div>
                ...
                <div className="flex flex-col gap-2 m-2 sm:w-1/2">
                    ...
                    <TextField value={specsInput.title} onChange={handleSpecsChange} name="title" label="Name" placeholder="Chapter" variant="outlined" size="small" />
                        <TextField value={specsInput.description} onChange={handleSpecsChange} name="description" label="Description" placeholder="topics" variant="outlined" size="small" />
                        <TextField value={specsInput.videourl} onChange={handleSpecsChange} name="videourl" label="Videourl" placeholder="url" variant="outlined" size="small" />
