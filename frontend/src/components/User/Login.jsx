            ...
            <main className="w-full mt-12 sm:pt-20 sm:mt-0">
                ...
                <div className="flex sm:w-4/6 sm:mt-4 m-auto mb-7 bg-white shadow-lg">
                    ...
                    <div className="loginSidebar bg-primary-blue p-10 pr-12 hidden sm:flex flex-col gap-4 w-2/5">
                        ...
                        <p className="text-gray-200 text-lg">Get access eLearning</p>
                    </div>
                    {/* <!-- sidebar column  --> */}
                    ...
                    <div className="flex-1 overflow-hidden">
                        ...
                        <div className="text-center py-10 px-4 sm:px-14">
                            ...
                            <form onSubmit={handleLogin}>
                                <div className="flex flex-col w-full gap-4">
                                    ...
                                    <div className="flex flex-col gap-2.5 mt-2 mb-32">
                                        <p className="text-xs text-primary-grey text-left">By continuing, you agree to eKaushalya's <a href="https://www.flipkart.com/pages/terms" className="text-primary-blue"> Terms of Use</a> and <a href="https://www.flipkart.com/pages/privacypolicy" className="text-primary-blue"> Privacy Policy.</a></p>
                            ...
                            <Link to="/register" className="font-medium text-sm text-primary-blue">New to eKaushalya? Create an account</Link>
                        </div>
                        {/* <!-- edit info container --> */}
