...
const ProductDetails = () => {
    ...
    const videoId = product.introductoryvideo;
                        ...
                        <div className="w-full flex flex-col sm:flex-row bg-white sm:p-2 relative">
                            ...
                            <div className="flex-1 py-2 px-3">
                                ...
                                <div className="flex flex-col gap-2 mb-4">
                                    ...
                                    {/*Intrductory Video Section */}
                                    <div className="w-full mt-6 rounded-sm border flex flex-col">
                                    <h1 className="px-6 py-4 border-b text-2xl font-medium">Introductory video</h1>
                                    <div className="p-6">
                                        {videoVisible && (
                                        <iframe width="560" height="315" src={`https://www.youtube.com/embed/${videoId}`}  allowFullScreen> 
                                        </iframe>
                                        )}
                                        </div>
                                            </div>
                                    ...
                                    <div className="w-full mt-4 pb-4 rounded-sm border flex flex-col">
                                        ...
                                        {product.specifications?.map((spec, i) => (
                                            <div className="px-6 py-2 flex items-center text-sm" key={i}>
                                                ...
                                                <p className="flex-1">{spec.videourl}</p>
                                            </div>
                                        ))}
                                        {/* <!-- specs list --> */}
