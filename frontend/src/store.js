...
import { checkReducer, instructorChecksReducer, instructorDetailsReducer, instructorReducer, instructorsReducer, newChecksReducer, newInstructorReducer } from './reducers/instructorReducer';
...
const reducer = combineReducers({
    ...
    newChecks: newChecksReducer,
    newInstructor: newInstructorReducer,
    instructor: instructorReducer,
    checks: instructorChecksReducer,
    check: checkReducer,
});
